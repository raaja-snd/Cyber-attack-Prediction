...
<div style='background-color:#F0F8FF; padding:15px; border-radius:10px;'>
    ...
    <p>This application allows you to detect the type of cyber attack based on raw network activity data.</p>
    <ul>
        <li>🔍 <strong>Input:</strong> Raw CSV file containing various network attributes</li>
        <li>🧠 <strong>Model:</strong> Trained Random Forest classifier</li>
        <li>📌 <strong>Prediction:</strong> One of <em>DDoS</em>, <em>Intrusion</em>, or <em>Malware</em></li>
    </ul>
    <p style="color:gray; font-size: 13px;">Note: Only the CSV upload option is enabled for better consistency and usability.</p>
</div>
